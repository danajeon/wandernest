...
export const SignIn = () => {
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-y-8 border border-solid border-black bg-white rounded-3xl flex flex-col items-center px-[20%] py-[3%]">
      <div className="-mb-6">
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-wandernest-blue to-wandernest-pink text-6xl">Sign In</span>
      </div>
      ...
      <div className="flex flex-col items-center">
        <Button text={"Sign In"}/>
        <span className="text-wandernest-purple text-xl pt-[5%] hover:underline">Create Account</span>
      </div>
    </div>
  );
};
