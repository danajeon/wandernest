...
export const CreateAccount = ({handleSignIn}) => {
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 space-y-8 border border-solid border-black bg-white rounded-3xl flex flex-col items-center w-[50%] py-[2%]">
      <div>
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-wandernest-blue to-wandernest-pink text-5xl">Create Account</span>
      </div>
